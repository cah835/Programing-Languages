...
extern char typechecker(); // check type of character
extern int string_checker(); //token checker for strings
extern int op_checker(); //token checker for opperators
extern int pun_checker();  // token checker for puncuation
